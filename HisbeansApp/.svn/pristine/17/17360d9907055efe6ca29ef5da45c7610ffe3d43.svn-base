 ...
 * @classname DepartmentMainAct.java
 * @package ghost.android.hbapp.department
 * @date 2012. 10. 23. 오전 10:29:22
 * @purpose : 매뉴&매장 소개 Main Activity Class
 * @comment :
 */

public class DepartmentMainAct extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*** Find View and Setting Event ***/
		
		menuBtn = (Button) findViewById(R.id.depart_menuIntroBtn);
		menuBtn.setOnClickListener(new OnClickListener(){

			@Override
			public void onClick(View v) {
				// Launch Depart_menu Screen
				intent = new Intent(DepartmentMainAct.this, DepartmentMenuAct.class);
		...
		menuBtn.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				if (event.getAction() == MotionEvent.ACTION_DOWN)
					v.setBackgroundResource(drawable.depart_menu_btn_press);
				if (event.getAction() == MotionEvent.ACTION_UP)
					v.setBackgroundResource(drawable.depart_menu_btn_normal);

				return false;
			}
		});

		shopBtn = (Button) findViewById(R.id.depart_shopLocBtn);
		shopBtn.setOnClickListener(new OnClickListener(){

			@Override
			public void onClick(View v) {
				// Launch Depart_shop Screen
				intent = new Intent(DepartmentMainAct.this, DepartmentShopAct.class);
				startActivity(intent);
			}
		});
		shopBtn.setOnTouchListener(new OnTouchListener() {

			public boolean onTouch(View v, MotionEvent event) {
				if (event.getAction() == MotionEvent.ACTION_DOWN)
					v.setBackgroundResource(drawable.depart_shop_btn_press);
				if (event.getAction() == MotionEvent.ACTION_UP)
					v.setBackgroundResource(drawable.depart_shop_btn_normal);

				return false;
			}
		});

		hisbeansBtn = (Button) findViewById(R.id.depart_hisbeansIntroBtn);
		hisbeansBtn.setOnClickListener(new OnClickListener(){

			@Override
			public void onClick(View v) {
				// Launch Depart_hisbeans Screen
				intent = new Intent(DepartmentMainAct.this, DepartmentHisbeansAct.class);
				startActivity(intent);
			}
		});
		hisbeansBtn.setOnTouchListener(new OnTouchListener() {

			public boolean onTouch(View v, MotionEvent event) {
				if (event.getAction() == MotionEvent.ACTION_DOWN)
					v.setBackgroundResource(drawable.depart_hisbeans_btn_press);
				if (event.getAction() == MotionEvent.ACTION_UP)
					v.setBackgroundResource(drawable.depart_hisbeans_btn_normal);
	...
	public void onBackPressed() {
		...
		new AlertDialog.Builder(DepartmentMainAct.this)
		.setTitle(alertTitle)
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case Menu.FIRST :
			...
			// Launch Login Screen
			intent = new Intent(DepartmentMainAct.this, LoginAct.class);
	...
	private void setUp(){
		...
		tab_stampBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(DepartmentMainAct.this, StampBarcodeMainAct.class);
		...
		tab_giftBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(DepartmentMainAct.this, GiftCardMainAct.class);
		...
		tab_settingBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(DepartmentMainAct.this, SettingMainAct.class);
