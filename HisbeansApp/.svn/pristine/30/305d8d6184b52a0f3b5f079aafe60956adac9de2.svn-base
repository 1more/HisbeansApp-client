...
public class GiftCardSendListAdapter extends BaseExpandableListAdapter {
	private LayoutInflater inflater;
	private GiftCardModel giftcard;

	public GiftCardSendListAdapter(Context c, GiftCardModel giftcard) {
		super();
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		String titleTxt = giftcard.get(groupPosition).getNick_name()
				+ "님께 선물하신 " + giftcard.get(groupPosition).getMenu();
